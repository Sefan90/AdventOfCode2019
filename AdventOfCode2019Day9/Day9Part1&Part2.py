...
def IntcodeComputer(input,startInput):
	...
	while i < len(input):
		if (modeChecker(input,relative,i) == 1):
			...
			i += 2
		#print("i:"+str(i)+" "+str(input[i]))

def Part1():
	bigList = [0] * 10000
	#inputList = [109, 1, 9, 2, 204, -6, 99]
	#inputList = [109,1,204,-1,1001,100,1,100,1008,100,16,101,1006,101,0,99]
	#inputList = [1102,34915192,34915192,7,4,7,99,0]
	#inputList = [104,1125899906842624,99]
	...
	IntcodeComputer(bigList,[startInput])
